...
<form method="post" action="{{ route('organization_url.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group @if ($errors->has('name')) has-error @endif">
                ...
                {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Organisation Name', 'required']) !!}
            ...
            <div class="form-group @if ($errors->has('url')) has-error @endif">
                ...
                <div class="input-group mb-3 @if ($errors->has('url')) has-error @endif">
                    ...
                    {!! Form::url('url', null, ['class' => 'form-control', 'placeholder' => 'Eg: https://www.citrix.com/en-in', 'required']) !!}
