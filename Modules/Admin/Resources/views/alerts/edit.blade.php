...
@section('main-content')
   <div class="breadcrumb">
        ...
        <ul>
            <li><a href="{{ route('alerts.index') }}">Tasks</a></li>
            <li>Add</li>
        </ul>
    </div>
                ...
                <div id="smartwizard">
                    ...
                    <div class="tab-content">
                        <div id="step-1" class="tab-pane" role="tabpanel">
                            <br />
                            <div class="row">
                                {{ Form::model(null, ['route' => ['alerts.update', ($alert->id != null? $alert->id: '')], 'method' => 'patch', 'id' => 'step1']) }}
                                <div class="col-md-6 form-group mb-3">             
                                    {{ Form::label('title', 'Title') }}
                                    {{ 
                                        Form::text('title', ($alert->title != null ? $alert->title : ''), [
                                            'id'      => 'title',
                                            'class'    => 'form-control',
                                            'maxlength' => 80,
                                ...
                                <div class="col-md-6 form-group mb-3">             
                                    ...
                                    {{ 
                                        Form::text('objective', ($alert->objective != null ? $alert->objective : ''), [
                                            'id'      => 'objective',
                                            'class'    => 'form-control',
                                            'maxlength' => 240,
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    {!! Form::textarea('summary', ($alert->summary != null ? $alert->summary : ''), ['id' => 'summary']) !!}

                                    {{ Form::hidden('alert_id', $alert->id, ['id' => 'alert_id']) }}
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    {!! Form::textarea('recommendation', ($alert->recommendation != null ? $alert->recommendation : ''), ['id' => 'recommendationArea']) !!}
                        ...
                        <!--<div id="step-2" class="tab-pane" role="tabpanel">
                            ...
                            {{ Form::model(null, ['route' => ['alerts.update', ($alert->id != null? $alert->id: '')], 'method' => 'patch', 'class' => 'dropzone', 'id' => 'file-upload']) }}
                                <div class="fallback">
                        ...
                        <div id="step-3" class="tab-pane" role="tabpanel">
                            ...
                            <br />
                            {{ Form::open(array( 'method' => 'post', 'route' => array('alerts.complete', $alert->id), 'autocomplete'=>'off', 'id' => 'stepFinal')) }}
                                @method('Put')
                            {{ Form::close() }}
                            <div class="iframeWrap">
                                <iframe id="previewTemplate" title="previewTemplate" src="{{ route('alerts.automatic_template', $alert->id) }}" frameborder="0" scrolling="no" >
                                </iframe>
                            </div>
                            <br />
        ...
        $("#file-upload").dropzone({
                ...
                $.ajax({
                    ...
                    success: function(response){
                        $.each(response, function(key,value) {
                            ...
                            myDropzone.emit("thumbnail", mockFile, "{{ route('storage.image', '') }}/"+value.filename+'/system_generated_report' );
            ...
            removedfile: function(file) 
            {
				if (this.options.dictRemoveFile) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: "{{ route('alert_gallery.destroy', '') }}/"+file.id,
                        dataType: "JSON",
                        data: {
                            "_token": "{{ csrf_token() }}",
                        },
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if(result.status == 'success'){
                            ...
                            $('#file-upload').prop('action', "{{ route('alerts.update', '') }}/"+result.data.id);
                        }
                    },
