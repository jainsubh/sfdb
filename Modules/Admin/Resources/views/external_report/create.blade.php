...
<form method="post" action="{{ route('external_report.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="modal-body">
        ...
        <!-- name Form Input -->
            <div class="form-group @if ($errors->has('title')) has-error @endif">
                ...
                {!! Form::text('title', null, ['class' => 'form-control', 'placeholder' => 'Name/Title for report', 'required']) !!}
            ...
            <div class="form-group @if ($errors->has('organization_name')) has-error @endif">
                ...
                {!! Form::text('organization_name', null, ['class' => 'form-control', 'placeholder' => 'Organisation Name', 'required']) !!}
            ...
            <div class="form-group @if ($errors->has('organization_url')) has-error @endif">
                ...
                <div class="input-group mb-3 @if ($errors->has('organization_url')) has-error @endif">
                    ...
                    {!! Form::url('organization_url', null, ['class' => 'form-control', 'placeholder' => 'Eg: https://www.citrix.com/en-in']) !!}
            ...
            <div class="form-group @if ($errors->has('type')) has-error @endif">
                ...
                {{ Form::select('type', ['external' => 'External', 'scenario' => 'Scenario'], '' , ['class' => 'form-control']) }}
            </div>

            <div class="form-group @if ($errors->has('comments')) has-error @endif">
                {!! Form::label('comments', 'Comments') !!}
                {!! Form::text('comments', null, ['class' => 'form-control', 'placeholder' => 'Enter comments', 'required']) !!}
