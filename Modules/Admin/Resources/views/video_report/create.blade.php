...
<form method="post" action="{{ route('video_report.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="modal-body">
        ...
        <!-- name Form Input -->
            <div class="form-group @if ($errors->has('title')) has-error @endif">
                ...
                {!! Form::text('title', null, ['class' => 'form-control', 'placeholder' => 'Name/Title for video report', 'required']) !!}
