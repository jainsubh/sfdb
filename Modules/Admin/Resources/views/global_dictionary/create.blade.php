<form method="post" action="{{ route('global_dictionary.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="modal-body">
        ...
        <div class="form-group @if ($errors->has('name')) has-error @endif">
            ...
            {!! Form::text('keywords', null, ['class' => 'form-control', 'placeholder' => 'keyword Name', 'required']) !!}
