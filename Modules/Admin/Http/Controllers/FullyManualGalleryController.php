...
class FullyManualGalleryController extends Controller
{
    use Authorizable;
    /**
    ...
    {
        $gallery = FullyManualGallery::where('fully_manual_id', $request->fully_manual_id)->get();
        $gallery_images = [];
        if(!$gallery->isEmpty()){
    ...
    {
        if( FullyManualGallery::findOrFail($id)->delete() ) {
