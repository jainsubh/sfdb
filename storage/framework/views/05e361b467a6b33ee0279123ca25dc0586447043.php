    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ajax: '<?php echo route("video_report.datatable"); ?>',
                ordering: false,
                serverSide: true,
                processing: true,
                columns:[
                    ...
                    dom: {
                    ...
                    },buttons: [
                        {
                            ...
                            action: function (e, node, config){
                                $.ajax({
                                    url: "<?php echo e(route('video_report.create')); ?>",
                                    type: 'GET',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/video_report/index.blade.php ENDPATH**/ ?>