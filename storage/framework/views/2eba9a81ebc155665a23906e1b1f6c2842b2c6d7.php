                    ...
                    <div class="col-md-12">
                        <div class="p-4 text-center">
                            ...
                            <div class="mt-3 text-center">
                                <a class=" btn btn-primary" href="<?php echo e(route('dashboard_version_1')); ?>">Dashboard</a>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/landing.blade.php ENDPATH**/ ?>