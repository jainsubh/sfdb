                    ...
                    <div class="tab-content">
                        <div id="step-1" class="tab-pane" role="tabpanel">
                            ...
                            <div class="row">
                                ...
                                <?php echo e(Form::open(array( 'method' => 'post', 'route' => 'semi_automatic.store', 'autocomplete'=>'off', 'id' => 'step1'))); ?>

                                <div class="col-md-6 form-group mb-3">
                                    <?php echo Form::label('title', 'Title'); ?>

                                    <?php echo Form::text('title', ($task->alert != null ? $task->alert->title : ''), 
                                    [
                                        'class' => 'form-control', 
                                        'autocomplete' => 'off', 
                                        'maxlength' => 90,
                                ...
                                <div class="col-md-6 form-group mb-3">             
                                    ...
                                    <?php echo e(Form::text('objective', ($task->semi_automatic != null ? $task->semi_automatic->objective : ''), [
                                            'id'      => 'objective',
                                            'class'    => 'form-control',
                                            'maxlength' => 45,
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    <?php echo e(Form::label('key_information', 'Key Information')); ?>

                                    <div id="full-editor">
                                        <?php if($task->semi_automatic != null): ?>
                                            <?php echo $task->semi_automatic->key_information; ?>

                                        <?php endif; ?>
                                    </div>
                                    <?php echo Form::textarea('key_information', ($task->semi_automatic != null ? $task->semi_automatic->key_information : ''), ['id' => 'keyInformationArea']); ?>
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <?php echo Form::textarea('recommendation', ($task->semi_automatic != null ? $task->semi_automatic->recommendation : ''), ['id' => 'recommendationArea']); ?>
                                    ...
                                    <?php echo e(Form::hidden('subject_id', $task->subject_id)); ?>

                                    <?php echo e(Form::hidden('semi_automatic_id', ($task->semi_automatic != null? $task->semi_automatic->id: ''), array('id' => 'semi_automatic_id'))); ?>
                        ...
                        <div id="step-2" class="tab-pane" role="tabpanel">
                            <br />
                            <?php echo e(Form::model(null, ['route' => ['semi_automatic.update', ($task->semi_automatic != null? $task->semi_automatic->id: '')], 'method' => 'patch', 'class' => 'dropzone', 'id' => 'file-upload'])); ?>
                        ...
                        <div id="step-3" class="tab-pane" role="tabpanel">
                            <br />
                                <?php echo e(Form::open(array( 'method' => 'post', 'route' => array('semi_automatic.complete', $task->id), 'autocomplete'=>'off', 'id' => 'stepFinal'))); ?>

                                    <?php echo method_field('Put'); ?>
                                <?php echo e(Form::close()); ?>

                                <div class="iframeWrap">
                                    <iframe id="previewTemplate" title="previewTemplate" src="<?php echo e(route('semi_automatic.show', $task->id)); ?>" frameborder="0" scrolling="yes" >
                                    </iframe>
                                </div>
                            <br />
                        </div>
    ...
    $(document).ready(function () {
        ...
        $("#file-upload").dropzone({
            ...
            init: function() {
                myDropzone = this;
                $.ajax({
                    url: "<?php echo e(route('semi_automatic_gallery.index')); ?>",
                    type: 'GET',
                    ...
                    success: function(response){
                        $.each(response, function(key,value) {
                            ...
                            myDropzone.emit("thumbnail", mockFile, "<?php echo e(route('storage.image', '')); ?>/"+value.filename+'/semi-automatic' );
            ...
            removedfile: function(file) 
            {
				if (this.options.dictRemoveFile) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: "<?php echo e(route('semi_automatic_gallery.destroy', '')); ?>/"+file.id,
                        dataType: "JSON",
                        data: {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if(result.status == 'success'){
                            ...
                            $('#file-upload').prop('action', "<?php echo e(route('semi_automatic.update', '')); ?>/"+result.data.id);
                        }
                    },
        ...
        function saveToServer(file, report_type) {
            ...
            xhr.open('POST', "<?php echo e(URL::to('/admin/semi_automatic/fileUpload')); ?>", true);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/semi_automatic/create.blade.php ENDPATH**/ ?>