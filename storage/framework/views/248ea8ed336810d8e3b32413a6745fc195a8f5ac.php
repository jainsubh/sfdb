...
<div id="alert-show-<?php echo e($freeform_report->id); ?>" style="display: contents">
    <div class="col-6 col-xs-12">
        <div class="alert-head">
            ...
            <div class="alert-sector">
                <div class="item">
                    ...
                    <div id="alert_sector" class="value"><?php echo e($freeform_report->sectors != null? $freeform_report->sectors->name:''); ?></div>
                </div>
                
                <div class="item">
                    <div class="title">Priority</div>
                    <div id="alert_department" class="<?php echo e($freeform_report->tasks->priority); ?>"><strong><?php echo e(ucfirst($freeform_report->tasks->priority)); ?></strong></div>
                </div>
            </div>
        </div>
        <div class="alert-title">
            ...
            <div id="alert_title" class="value"> 
                <?php echo e($freeform_report->title); ?>
        ...
        <div class="alert-summary">
            ...
            <div class="scroll-inner">
                <div class="txt white">
                    <p id="alert_summary">
                        <?php echo e($freeform_report->objective); ?>
    ...
    <div class="col-6 col-xs-12">
                ...
                <div class="title" style="text-align: right; margin: 0px 30px 4px 0px;">Reports</div>
                    <div class="ref-icons">
                        <div class="icons">
                            ...
                            <?php if($freeform_report && $freeform_report->tasks->status == 'complete'): ?>
                                <div class="tooltip"> 
                                    <div class="ref-icon">  
                                        <a href="<?php echo e(route('freeform_report.download', $freeform_report->ref_id)); ?>">
                                            <img src="images/ref-star.svg" alt="download_freeform_report" class="icon">
                                            <div class="tooltiptext" style="top:-3.7em; width: 190px; text-align: left; padding-left: 15px;">FreeForm Report <br> <?php echo e($freeform_report->ref_id); ?></div>
                                        </a>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasRole('Analyst|Supervisor')): ?>
                                <?php if($freeform_report->tasks && $freeform_report->tasks->latest_task_log && Auth::id() == $freeform_report->tasks->latest_task_log->assigned_to): ?>
                                    <?php if($freeform_report && $freeform_report->status != 'complete'): ?>
                                    <div class="tooltip"> 
                                        <div class="ref-icon">  
                                            <a href="<?php echo e(route('freeform_report.report_create', $freeform_report->id)); ?>" target="_blank">
                                                <img src="images/ref-star.svg" alt="create_freeform_report" class="icon">
                                                <div class="tooltiptext" style="top:-3.7em; width: 190px; text-align: left; padding-left: 15px;">FreeForm Report <br> <?php echo e($freeform_report->ref_id); ?></div>
                                            </a>
                                        </div>
                                    </div>
                                    <?php elseif($freeform_report->status == 'complete' && $freeform_report->tasks->status != 'complete'): ?>
                                    <div class="tooltip"> 
                                        <div class="ref-icon">  
        ...
        <div class="mng-alert-buttons mg-10">
            <?php if(auth()->check() && auth()->user()->hasRole('Manager|Supervisor')): ?>
                ...
                <?php if($freeform_report->tasks->status ==  'pending' || !$freeform_report->tasks): ?>
                    <?php echo e(Form::open(array('route' => 'tasks.store', 'method' => 'post' , 'id' => 'assign_to'))); ?>

                    <?php echo e(Form::hidden('freeform_report_id', $freeform_report->id)); ?>
                    ...
                    <div class="assign">
                        <?php if($freeform_report->tasks->status == 'pending'): ?>
                            <?php echo e(Form::hidden('request_type', 'reassign')); ?>

                            <?php echo e(Form::hidden('task_id', $freeform_report->tasks->id, array('id' => 'task_id'))); ?>
                ...
                <?php elseif($freeform_report->tasks->status ==  'complete'): ?>
                    <p class="title" style="text-align:center; line-height: 42px">Task has been completed by <?php echo e($freeform_report->tasks->completed_by_user->name); ?>

                        <button class="button-red btn-primary" style="float: right" onclick="reopen('<?php echo e($freeform_report->tasks->id); ?>')" href="javascript:void(0)"> Reopen </button>
                    </p>
                <?php else: ?>
                    <?php if(auth()->user()->id == $freeform_report->tasks->latest_task_log->assigned_to): ?>
                        <div class="alert-buttons" style="margin-top:2%">
                            <div class="transfer">
                                <?php echo e(Form::open(array('route' => 'tasks.transfer', 'method' => 'post', 'id' => 'transfer_form'))); ?> 
                                    <?php if(isset($freeform_report->tasks)): ?>
                            ...
                            <div class="send">
                                <?php if($freeform_report->tasks && $freeform_report->status == 'complete' && $freeform_report->tasks->status != 'complete'): ?>
                                    <button class="button btn-primary ladda-button example-button m-1" data-style="expand-right" onclick="completeTask('<?php echo e($freeform_report->tasks->id); ?>')" href="javascript:void(0)"> complete & send </button>
                                <?php else: ?>
                    ...
                    <?php else: ?>
                    <p class="title" style="text-align:center">Task has assigned to <?php echo e($freeform_report->tasks->latest_task_log->assigned_to_user->name); ?></p>
                    <?php endif; ?>
                <?php endif; ?>
                </div>
            <?php endif; ?>
            <?php if(auth()->check() && auth()->user()->hasRole('Analyst')): ?>
                <?php if($freeform_report->tasks && $freeform_report->tasks->status == 'complete'): ?>
        ...
        <div class="panel-modal-content">
            ...
            <div class="modal-footer" style="margin-top: 25px; ">  
                <div class="col-md-12 col-sm-12 col-xs-12" style="text-align:center; margin-bottom: 25px;">
                    <button class="button" onclick="window.location='<?php echo e(route('freeform_report.download', $freeform_report->ref_id  )); ?>'" style="margin-right: 15px;"> Download Report </button> 
                    <button class="button" id="regenerate" onclick="regenerate('<?php echo e($freeform_report->id); ?>', 'freeform_report')"> Continue Report </button>
                </div> 
            </div>
        </div>
    </div>
</div>
<?php /**PATH /Volumes/Data/sfdbd_new/resources/views/freeform_report/show.blade.php ENDPATH**/ ?>