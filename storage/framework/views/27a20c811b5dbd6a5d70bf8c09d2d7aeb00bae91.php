...
<form method="post" action="<?php echo e(route('external_report.update', $external_report->id)); ?>" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        <div class="form-group <?php if($errors->has('message')): ?> has-error <?php endif; ?>">
            <div class="form-group <?php if($errors->has('title')): ?> has-error <?php endif; ?>">
                ...
                <?php echo Form::text('title', $external_report->title, ['class' => 'form-control', 'placeholder' => 'Name/Title for report', 'required']); ?>
            ...
            <div class="form-group <?php if($errors->has('organization_name')): ?> has-error <?php endif; ?>">
                ...
                <?php echo Form::text('organization_name', $external_report->organization_name, ['class' => 'form-control', 'placeholder' => 'Organization Name', 'required']); ?>
            ...
            <div class="form-group <?php if($errors->has('organization_url')): ?> has-error <?php endif; ?>">
                ...
                <div class="input-group mb-3 <?php if($errors->has('organization_url')): ?> has-error <?php endif; ?>">
                    ...
                    <?php echo Form::url('organization_url', $external_report->organization_url, ['class' => 'form-control', 'placeholder' => 'Eg: https://www.citrix.com/en-in']); ?>
            ...
            <div class="form-group <?php if($errors->has('type')): ?> has-error <?php endif; ?>">
                <?php echo e(Form::label('type','Select Type')); ?>

                <?php echo e(Form::select('type', ['external' => 'External', 'scenario' => 'Scenario'], $external_report->type  , ['class' => 'form-control'])); ?>
            ...
            <div class="form-group <?php if($errors->has('comments')): ?> has-error <?php endif; ?>">
                ...
                <?php echo Form::text('comments', $external_report->comments , ['class' => 'form-control', 'placeholder' => 'Enter comments', 'required']); ?>
            ...
            <div class="input-group my-3">
                ...
                <div class="custom-file">
                    <?php echo Form::hidden('hidden_report', $external_report->external_report); ?>

                    <?php echo Form::file('external_report', ['class' => 'custom-file-input', 'id' => 'inputGroupFile01', 'aria-describedby' => "inputGroupFileAddon01"]); ?>

                    <?php echo Form::label('inputGroupFile01', $external_report->external_report , ['class'=>'custom-file-label']); ?>

                </div>
            </div>
            <p style="color:red">File should be only in pdf format, max size allowed 50MB</p>
            <?php if($errors->has('external_report')): ?> <p class="help-block"><?php echo e($errors->first('external_report')); ?></p> <?php endif; ?>
...
<?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/external_report/edit.blade.php ENDPATH**/ ?>