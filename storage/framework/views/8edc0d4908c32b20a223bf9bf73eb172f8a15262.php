<form method="post" action="<?php echo e(route('global_dictionary.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="modal-body">
        ...
        <div class="form-group <?php if($errors->has('name')): ?> has-error <?php endif; ?>">
            ...
            <?php echo Form::text('keywords', null, ['class' => 'form-control', 'placeholder' => 'keyword Name', 'required']); ?>
...
<?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/global_dictionary/create.blade.php ENDPATH**/ ?>