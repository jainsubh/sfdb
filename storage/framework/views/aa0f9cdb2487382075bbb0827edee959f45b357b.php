...
<form method="post" action="<?php echo e(route('video_report.update', $video_report->id)); ?>" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        <div class="form-group <?php if($errors->has('message')): ?> has-error <?php endif; ?>">
            <div class="form-group <?php if($errors->has('title')): ?> has-error <?php endif; ?>">
                ...
                <?php echo Form::text('title', $video_report->title, ['class' => 'form-control', 'placeholder' => 'Name/Title for report', 'required']); ?>
            ...
            <div class="form-group <?php if($errors->has('organization_name')): ?> has-error <?php endif; ?>">
                ...
                <?php echo Form::text('organization_name', $video_report->organization_name, ['class' => 'form-control', 'placeholder' => 'Organization Name', 'required']); ?>
            ...
            <div class="form-group <?php if($errors->has('organization_url')): ?> has-error <?php endif; ?>">
                ...
                <div class="input-group mb-3 <?php if($errors->has('organization_url')): ?> has-error <?php endif; ?>">
                    ...
                    <?php echo Form::url('organization_url', $video_report->organization_url, ['class' => 'form-control', 'placeholder' => 'Eg: https://www.citrix.com/en-in']); ?>
            ...
            <div class="form-group <?php if($errors->has('comments')): ?> has-error <?php endif; ?>">
                ...
                <?php echo Form::text('comments', $video_report->comments , ['class' => 'form-control', 'placeholder' => 'Enter comments', 'required']); ?>
            ...
            <div class="input-group my-3">
                ...
                <div class="custom-file">
                    <?php echo Form::hidden('hidden_report', $video_report->video_report); ?>

                    <?php echo Form::file('video_report', ['class' => 'custom-file-input', 'id' => 'inputGroupFile01', 'aria-describedby' => "inputGroupFileAddon01"]); ?>

                    <?php echo Form::label('inputGroupFile01', $video_report->video_report , ['class'=>'custom-file-label']); ?>
...
<?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/video_report/edit.blade.php ENDPATH**/ ?>