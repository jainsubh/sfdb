            ...
            <div id="smartwizard">
                ...
                <div class="tab-content">
                    <div id="step-1" class="tab-pane" role="tabpanel">
                        <br />
                        <?php echo e(Form::model($product_report, ['route' => ['product.update', $product_report->id], 'method' => 'patch', 'id' => 'step1'])); ?>

                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    <?php echo e(Form::label('sector','Sector')); ?>

                                    <?php echo e(Form::select('sector_id', $sectors, $product_report->subject_id, ['class' => 'form-control'])); ?>
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <?php echo e(Form::select('priority', ['low' => 'Low', 'medium' => 'Medium', 'high' => 'High'], $product_report->priority, ['class' => 'form-control'])); ?>
                                ...
                                <div class="col-md-6 form-group mb-2">             
                                    ...
                                    <?php echo e(Form::text('objectives', $product_report->objectives, [
                                            'id'      => 'objectives',
                                            'class'    => 'form-control',
                                            'maxlength' => 45,
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <?php echo Form::text('ref_id', $product_report->ref_id, ['class' => 'form-control disabled','autocomplete' => 'off', 'style' => 'margin-bottom:15px', 'required', 'disabled']); ?>
                    ...
                    <div id="step-2" class="tab-pane" role="tabpanel">
                        <br />
                        <?php echo e(Form::model($product_report, ['route' => ['product.update', $product_report->id], 'method' => 'patch', 'id' => 'step2'])); ?>

                        <div class="row">
                            <div class="col-md-6 form-group mb-2">
                                <?php echo Form::label('title', 'Title'); ?>

                                <?php echo Form::text('title', $product_report->title, 
                                [
                                    'class' => 'form-control', 
                                    'autocomplete' => 'off', 
                                    'maxlength' => 90,
                            ...
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <?php echo Form::textarea('summary', $product_report->summary, ['id' => 'summary_editor_area']); ?>

                                <span class="quill_counter">Character limit: <span id="summary_span">0</span> / 1045</span>
                            </div>

                            <div class="col-md-12 form-group mb-3">
                                <?php echo Form::label('vendor_information', 'Vendor Information'); ?>

                                <div id="vendor_editor">
                                    <?php echo $product_report->vendor_information; ?>

                                </div>
                                <?php echo Form::textarea('vendor_information', $product_report->vendor_information, ['id' => 'vendor_editor_area']); ?>
                    ...
                    <div id="step-3" class="tab-pane" role="tabpanel">
                        <br />
                        <?php echo e(Form::model($product_report, ['route' => ['product.update', $product_report->id], 'method' => 'patch', 'id' => 'step3'])); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <?php echo Form::textarea('features', $product_report->features, ['id' => 'feature_editor_area']); ?>

                                <span class="quill_counter">Character limit: <span id="features_span">0</span> / 595</span>
                            </div>
                            
                            <div class="col-md-12 form-group mb-3">
                                <?php echo Form::label('negatives', 'Disadvantages'); ?>

                                <div id="negative_editor">
                                    <?php echo $product_report->negatives; ?>

                                </div>
                                <?php echo Form::textarea('negatives', $product_report->negatives, ['id' => 'negative_editor_area']); ?>
                            ...
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <?php echo Form::textarea('advantages', $product_report->advantages, ['id' => 'advantage_editor_area']); ?>
                    ...
                    <div id="step-4" class="tab-pane" role="tabpanel">
                        <br />
                        <?php echo e(Form::model($product_report, ['route' => ['product.update', $product_report->id], 'method' => 'patch', 'class' => 'dropzone', 'id' => 'file-upload'])); ?>
                    ...
                    <div id="step-5" class="tab-pane" role="tabpanel">
                        <br />
                        <?php echo e(Form::model($product_report, ['route' => ['product.complete', $product_report->id], 'method' => 'patch', 'id' => 'stepFinal'])); ?>

                            <?php echo method_field('Put'); ?>
                        <?php echo e(Form::close()); ?>

                        <div class="iframeWrap">
                            <iframe id="previewTemplate" title="previewTemplate" src="<?php echo e(route('product.show', $product_report->id)); ?>" frameborder="0" scrolling="no" >
                            </iframe>
                        </div>
                        <br />
                    </div>
    ...
    $(document).ready(function () {
        ...
        $("#file-upload").dropzone({
            ...
            init: function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('product_gallery.index')); ?>",
                    type: 'GET',
                    data: {'product_id': "<?php echo e($product_report->id); ?>" },
                    dataType: 'json',
                    success: function(response){
                        $.each(response, function(key,value) {
                            var mockFile = { name: value.filename, size: value.size, id: value.id };
                            myDropzone.emit("addedfile", mockFile);
                            myDropzone.emit("thumbnail", mockFile, "<?php echo e(route('storage.image', '')); ?>/"+value.filename+'/product' );
            ...
            removedfile: function(file) 
            {
				if (this.options.dictRemoveFile) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: "<?php echo e(route('product_gallery.destroy', '')); ?>/"+file.id,
                        dataType: "JSON",
                        data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/product/edit.blade.php ENDPATH**/ ?>