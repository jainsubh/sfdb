    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group <?php if($errors->has('name')): ?> has-error <?php endif; ?>">
                ...
                <?php echo Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Department Name', 'required']); ?>
...
<?php echo Form::close(); ?><?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/departments/create.blade.php ENDPATH**/ ?>