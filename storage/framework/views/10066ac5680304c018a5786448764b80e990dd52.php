<form method="post" action="<?php echo e(route('data.store')); ?>" enctype="multipart/form-data">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?php echo e(Form::hidden('dataset_id', $dataset_id)); ?>
...
<?php echo Form::close(); ?><?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/data/create.blade.php ENDPATH**/ ?>