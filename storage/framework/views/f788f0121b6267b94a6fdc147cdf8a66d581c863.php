    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ajax: '<?php echo route("alerts.datatable"); ?>',
                ordering: false,
                serverSide: true,
                processing: true,
                columns:[
                    ...
                    dom: {
                    ...
                    },buttons: [
                        {
                            ...
                            action: function ( e, dt, node, config ) {
                                ...
                                //window.location.href = "<?php echo e(route('alerts.edit', '')); ?>/"+row_data.id;
                                var url = "<?php echo e(route('alerts.edit', ':id')); ?>";
                                alert_edit_url = url.replace(':id', row_data.id);
                                window.location.href = alert_edit_url;
                            },
                            enabled: false
                        },
                        /*{
                        ...
                        },
                        {
                            ...
                            action: function ( e, dt, node, config ) {
                                ...
                                $.ajax({
                                    url: "<?php echo e(route('institution_report.archive', '')); ?>/"+ids,
                                    type: 'PUT',
                                    dataType: 'json',
                                    data: {
                                        "_token": "<?php echo e(csrf_token()); ?>",
            ...
            $('<label class="pull-right" style="width: 154px; margin-left: 15px;">'+
                ...
                '</select>'+ 
                '</label>'+
                '<button type="reset" id="reset" class="form-control" style="float:left; width:80px; cursor:pointer; margin-left:15px">Reset All</button>')
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/alerts/index.blade.php ENDPATH**/ ?>