    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                'ajax': '<?php echo route("events.datatable"); ?>',
                "ordering": false,
                columns:[
                    { data: 'name'},
                    ...
                    dom: {
                    ...
                    },buttons: [
                        {
                            ...
                            action: function ( e, dt, node, config ) {                           
                               window.location = '<?php echo route("events.create"); ?>';
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            action: function ( e, dt, node, config ) {           
                                ...
                                var id = row_data.id;              
                                $.ajax({
                                    url: "<?php echo e(route('events.immediate_crawl', '')); ?>/"+id,
                                    type: 'PUT',
                                    dataType: 'json',
                                    data: {
            ...
            function get_crawl_status(id){
                $.ajax({
                    url: "<?php echo e(route('events.crawl_status', '')); ?>/"+id,
                    type: 'GET',
                    dataType: 'json',
                    success: function(result){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/events/index.blade.php ENDPATH**/ ?>