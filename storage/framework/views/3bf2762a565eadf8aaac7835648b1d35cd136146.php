  ...
  <body>
    <div class="wrapper">
      <div class="wrap container-fluid">
          ...
          <!-- <?php echo $__env->make('layouts.includes.alert-navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> -->
            ...
            <div class="col-12 col-xs-12">
                ...
                <div class="module-alert"> 
                  <div class="marquee-horz" style="width:800px" data-speed=60 data-pauseOnHover='true' data-pauseOnCycle='true' >
                      <h3 class="red" style="text-align:left; margin-left:12px"><?php echo e(Str::limit($alert->title,140)); ?></h3>
                  </div>
                </div>
              </div>
            </div>
                ...
                <article id="summary-panel" class="module">
                  ...
                  <div class="scroll-wrapper summary-item">
                    <div class="scroll-inner">
                      <div class="summary" >
                        <p style="text-align: justify" id="summary_meaning"><?php echo e($alert->summary); ?></p><br>
                      </div>
                    </div>
                  </div>  
                </article>
                  ...
                  <div class="scroll-wrapper source-list">
                    <div class="scroll-inner">
                      <div class="source-content">
                        <?php $__currentLoopData = $alert->links->pluck('url'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $links): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <a href="<?php echo e($links); ?>" target="_blank" style="color:white; "> <p> <?php echo e($links); ?></p> </a>
                    ...
                    <div class="row">
                      <div class="col-4 col-xs-4">
                        <div class="tw-no-item">
                          <div class="tw-no green"><?php echo e($alert->positive); ?></div>
                          <div class="tw-txt">positive</div>
                        </div>
                      </div>
                      <div class="col-4 col-xs-4">
                        <div class="tw-no-item">
                          <div class="tw-no orange"><?php echo e($alert->neutral); ?></div>
                          <div class="tw-txt">neutral</div>
                        </div>
                      </div>
                      <div class="col-4 col-xs-4">
                        <div class="tw-no-item">
                          <div class="tw-no red"><?php echo e($alert->negative); ?></div>
                      ...
                      <div class="table-content">
                        <table aria-describedby=""  border="0">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td style="width:33%">
                                  <?php echo e($countries->country->country_name); ?>

                              </td>
                              <td style="width:33%">
                                  <?php echo e($countries->country->city); ?>

                              </td>
                              <!--<td style="width:33%"><?php echo e(rand(1,25)); ?></td>-->
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </tbody>
                        </table>
                    ...
                    <div class="scroll-inner">
                      <div class="table-content">
                        <table aria-describedby=""  border="0">
                          ...
                          <tbody>
                            <?php $__currentLoopData = $alert->events->eventdepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              <td style="width:22.66%">
                              <?php echo e($value->departments->name); ?>
                    ...
                    <div class="scroll-inner">
                      <div class="table-content">
                        <table aria-describedby=""  border="0">
                          ...
                          <tbody>
                            <?php $__currentLoopData = $alert->keywords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              <td style="width:50%"><?php echo e($value->keyword); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </tbody>
                        </table>
    ...
    <script>
      ...
      fetch('<?php echo e(route("alerts.countries", "")); ?>/<?php echo e($alert->id); ?>')
        .then((res) => res.json())
        .then((data) => {
          cities = data;
      ...
      //fetch('<?php echo e(URL::to('/')); ?>'+'/data.json')
      fetch('<?php echo e(route("alerts.knowledgeMap", "")); ?>/<?php echo e($alert->id); ?>')
        .then((res) => res.json())
        .then((data) => {
...
<?php /**PATH /Volumes/Data/sfdbd_new/resources/views/alerts/index.blade.php ENDPATH**/ ?>