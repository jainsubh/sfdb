...
<div id="alert-show-<?php echo e($external_report->id); ?>" style="display: contents">
    <div class="col-6 col-xs-12">
        <div class="alert-head">
            ...
            <div class="alert-sector">
                <div class="item">
                    ...
                    <div id="alert_sector" class="value"><?php echo e($external_report->organization_name); ?></div>
                </div>
                
                <div class="item">
                    <div class="title">Priority</div>
                    <div id="alert_department" class="<?php echo e($external_report->tasks->priority); ?>"><strong><?php echo e(ucfirst($external_report->tasks->priority)); ?></strong></div>
                </div>
            </div>
        </div>
        <div class="alert-title">
            ...
            <div id="alert_title" class="value"> 
                <?php echo e($external_report->title); ?>
        ...
        <div class="alert-title">
            ...
            <div id="alert_title" class="value"> 
                <?php echo e($external_report->organization_url); ?>
        ...
        <div class="alert-title">
            ...
            <div id="alert_title" class="value"> 
                <?php echo e($external_report->comments); ?>
    ...
    <div class="col-6 col-xs-12">
                    ...
                    <div class="ref-icons">
                        <div class="icons">                 
                            <?php if(auth()->check() && auth()->user()->hasRole('Analyst|Supervisor')): ?>
                                <?php if($external_report->tasks && $external_report->tasks->fully_manual): ?>
                                <div class="tooltip">
                                    <div class="ref-icon">
                                        <?php if($external_report->tasks->fully_manual->status != 'complete'): ?>
                                        <a href="<?php echo e(route('fully_manual.edit', $external_report->tasks->fully_manual->id)); ?>">
                                        <?php elseif($external_report->tasks->fully_manual->status == 'complete' && $external_report->tasks->status != 'complete'): ?>
                                        <a href="javascript:void(0)" class="report_modal" onclick="report_modal('fully_manual')">
                                        <?php else: ?>
                                        <a href="<?php echo e(route('fully_manual.download', $external_report->tasks->fully_manual->ref_id)); ?>">
                                        <?php endif; ?>
                                            <img src="images/ref-edit.svg" alt="fully_manual_report" class="icon">
                                            <div class="tooltiptext" style="top:-3.7em; width: 190px; text-align: left; padding-left: 15px;">Fully Manual <br> <?php echo e($external_report->tasks->fully_manual->ref_id); ?></div>
                                        </a>
                                    </div>
                                </div>
                                <?php else: ?>
                                <div class="tooltip">
                                    <div class="ref-icon">
                                        <a onclick="generateFullyManual('<?php echo e($external_report->tasks->id); ?>')" href="javascript:void(0)">
                                ...
                                <?php if($external_report->tasks && $external_report->tasks->product): ?>
                                <div class="tooltip">
                                    <div class="ref-icon">
                                        <?php if($external_report->tasks->product->status != 'complete'): ?>
                                        <a href="<?php echo e(route('product.edit', $external_report->tasks->product->id)); ?>">
                                        <?php elseif($external_report->tasks->product->status == 'complete' && $external_report->tasks->status != 'complete'): ?>
                                        <a href="javascript:void(0)" class="report_modal" onclick="report_modal('product')">
                                        <?php else: ?>
                                        <a href="<?php echo e(route('product.download', $external_report->tasks->product->ref_id)); ?>">
                                        <?php endif; ?>
                                            <img src="images/ref-edit.svg" alt="product_report" class="icon">
                                            <div class="tooltiptext" style="top:-3.7em; width: 190px; text-align: left; padding-left: 15px;">Product <br> <?php echo e($external_report->tasks->product->ref_id); ?></div>
                                        </a>
                                    </div>
                                </div>
                                <?php else: ?>
                                <div class="tooltip">
                                    <div class="ref-icon">
                                        <a onclick="generateProduct('<?php echo e($external_report->tasks->id); ?>')" href="javascript:void(0)">
                            ...
                            <?php if(auth()->check() && auth()->user()->hasRole('Manager')): ?>
                                <?php if($external_report->tasks && $external_report->tasks->fully_manual && $external_report->tasks->fully_manual->status == 'complete'): ?>
                                <div class="tooltip">
                                    <div class="ref-icon">
                                        <a href="<?php echo e(route('fully_manual.download', $external_report->tasks->fully_manual->ref_id)); ?>">
                                        <img src="images/ref-edit.svg" alt="fully_manual_report" class="icon">
                                ...
                                <?php if($external_report->tasks && $external_report->tasks->product && $external_report->tasks->product->status == 'complete'): ?>
                                <div class="tooltip">
                                    <div class="ref-icon">
                                        <a href="<?php echo e(route('product.download', $external_report->tasks->product->ref_id)); ?>">
                                        <img src="images/ref-edit.svg" alt="product_report" class="icon">
                            ...
                            <div class="tooltip">
                                <div class="ref-icon">
                                    <a href="<?php echo e(route('external_report.download', $external_report->external_report)); ?>">
                                        <img src="images/ref-star.svg" alt="download_external_report" class="icon">
                                        <div class="tooltiptext" style="top:-3.7em; width: 190px; text-align: left; padding-left: 15px;">
                                            External Report <br /><?php echo e($external_report->external_report); ?>
        ...
        <div class="mng-alert-buttons mg-10">
            <?php if(auth()->check() && auth()->user()->hasRole('Manager|Supervisor')): ?>
                ...
                <?php if($external_report->tasks->status ==  'pending' || !$external_report->tasks): ?>
                    <?php echo e(Form::open(array('route' => 'tasks.store', 'method' => 'post' , 'id' => 'assign_to'))); ?>

                    <?php echo e(Form::hidden('report_id', $external_report->id)); ?>
                    ...
                    <div class="assign">
                        <?php if($external_report->tasks->status == 'pending'): ?>
                            <?php echo e(Form::hidden('request_type', 'reassign')); ?>

                            <?php echo e(Form::hidden('task_id', $external_report->tasks->id, array('id' => 'task_id'))); ?>
                ...
                <?php elseif($external_report->tasks->status ==  'complete'): ?>
                    <p class="title" style="text-align:center; line-height: 42px">Task has been completed by <?php echo e($external_report->tasks->completed_by_user->name); ?>

                        <button class="button-red btn-primary" style="float: right" onclick="reopen('<?php echo e($external_report->tasks->id); ?>')" href="javascript:void(0)"> Reopen </button>
                    </p>
                <?php else: ?>
                    <?php if(auth()->user()->id == $external_report->tasks->latest_task_log->assigned_to): ?>
                    <div class="alert-buttons" style="margin-top:2%">
                        <div class="transfer">
                            <?php echo e(Form::open(array('route' => 'tasks.transfer', 'method' => 'post', 'id' => 'transfer_form'))); ?> 
                                <?php if(isset($external_report->tasks)): ?>
                        ...
                        <div class="send">
                            <?php if($external_report->tasks && $external_report->tasks->fully_manual && $external_report->tasks->fully_manual->status == 'complete' && $external_report->tasks->status != 'complete'): ?>
                                <button class="button btn-primary ladda-button example-button m-1" data-style="expand-right" onclick="completeTask('<?php echo e($external_report->tasks->id); ?>')" href="javascript:void(0)"> complete & send </button>
                            <?php else: ?>
                    ...
                    <?php else: ?>
                    <p class="title" style="text-align:center">Task has assigned to <?php echo e($external_report->tasks->latest_task_log->assigned_to_user->name); ?></p>
                    <?php endif; ?>
                <?php endif; ?>
                </div>
            <?php endif; ?>
            <?php if(auth()->check() && auth()->user()->hasRole('Analyst')): ?>
                <?php if($external_report->tasks && $external_report->tasks->status == 'complete'): ?>
            ...
            <div class="modal-footer" style="margin-top: 25px; ">  
                <div class="col-md-12 col-sm-12 col-xs-12" style="text-align:center; margin-bottom: 25px;">
                    <div class="btn_fully_manual" style="display:none">
                        <?php if($external_report->tasks && $external_report->tasks->fully_manual): ?>
                        <button class="button" onclick="window.location='<?php echo e(route('fully_manual.download', $external_report->tasks->fully_manual->ref_id )); ?>'" style="margin-right: 15px;"> Download Report </button>
                        <button class="button" id="regenerate" onclick="regenerate('<?php echo e($external_report->tasks->fully_manual->id); ?>', 'fully_manual')"> Continue Report </button>
                        <?php endif; ?>
                    </div>

                    <div class="btn_product" style="display:none">
                        <?php if($external_report->tasks && $external_report->tasks->product): ?>
                        <button class="button" onclick="window.location='<?php echo e(route('product.download', $external_report->tasks->product->ref_id )); ?>'" style="margin-right: 15px;"> Download Report </button>
                        <button class="button" id="regenerate" onclick="regenerate('<?php echo e($external_report->tasks->product->id); ?>', 'product')"> Continue Report </button>
                        <?php endif; ?>
                    </div>
                </div> 
            </div>
...
<?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/external_report/show.blade.php ENDPATH**/ ?>