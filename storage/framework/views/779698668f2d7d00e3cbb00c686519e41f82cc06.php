            ...
            <div class="table-responsive">
                ...
                <thead>
                    <tr>
                        ...
                        <?php if(auth()->check() && auth()->user()->hasRole('Admin|Manager|Supervisor')): ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                'ajax': '<?php echo route("tasks.datatable"); ?>',
                ordering: true,
                serverSide: true,
                processing: true,
                columns:[
                        ...
                        buttons: [
                            {
                                ...
                                action: function ( e, dt, node, config ) {
                                    ...
                                    if(row_data.subject_type == 'institution_report'){
                                        ...
                                        window.location.href = "<?php echo e(route('freeform_report.report_create', '')); ?>/"+row_data.subject.id;
                                    }else{
                                        ...
                                        if(semi_button_visibile == false && manual_button_visibile == false){
                                            ...
                                            swal({
                                                ...
                                                if(val == 'semi_automatic'){
                                                    window.location.href = "<?php echo e(route('semi_automatic.create')); ?>/task/"+row_data.id;
                                                }
                            ...
                            },
                            {
                                ...
                                action: function ( e, dt, node, config ) {
                                    ...
                                    var row_data = dt.row( { selected: true } ).data();
                                    $.ajax({
                                        url: "<?php echo e(route('tasks.complete', '')); ?>/"+row_data.id,
                                        type: 'PUT',
                                        dataType: 'json',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/tasks/index.blade.php ENDPATH**/ ?>