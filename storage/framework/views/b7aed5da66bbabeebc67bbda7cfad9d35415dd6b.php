...
<script src="<?php echo e(asset('js/TweenMax.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('js/text_scroller.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('js/owl.carousel.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('js/simple-lightbox.jquery.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('js/moment.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('js/tavo-calendar.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('js/flatpickr.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('js/onScroll_load.min.js')); ?>" type="text/javascript"></script>
  ...
  </script><?php /**PATH /Volumes/Data/sfdbd_new/resources/views/layouts/includes/footer-scripts.blade.php ENDPATH**/ ?>