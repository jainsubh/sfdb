                              ...
                              <div class="row"  id="team_report_content">
                                ...
                                <div class="col-6 col-sm-12 col-xs-12" style="cursor:pointer" id="<?php echo e($task->subject_type.'_'.$task->subject_id); ?>" onclick="show_alert('<?php echo e($task->subject_id); ?>', '<?php echo e($task->subject_type); ?>')">
                                    <div class="myreports-item">
                                      ...
                                      <p class="date red">
                                          Completed Date : <?php echo e(\Carbon\Carbon::parse($task->completed_at, 'UTC')->setTimezone(auth()->user()->timezone)->isoFormat('lll')); ?>
                          ...
                          <div class="scroll-inner">
                            <div class="myreports-content">
                              ...
                              <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-6 col-sm-12 col-xs-12" id="events_<?php echo e($event->id); ?>" style="curson:pointer" onclick="show_alert('<?php echo e($event->id); ?>', 'events')">
                                  <div class="myreports-item">
                                    <p style=" white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                    ...
                                    <p class="person blue">Created By: <?php echo e((($event->created_by_user)?$event->created_by_user->name : 'Anonymous')); ?></p>
                              ...
                              <?php $__currentLoopData = @$institution_report; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="ireports-item ireports_<?php echo e($report['institution_report']); ?>" id="institution_report_<?php echo e($report['id']); ?>">
                                  <div class="item-download"> 
                                    <a href="<?php echo e(route('institution_report.download', $report['institution_report'])); ?>">
                                  ...
                                  <p><?php echo e(Str::limit($report['name'], 28)); ?></p>
...
<?php /**PATH /Volumes/Data/sfdbd_new/resources/views/analyst.blade.php ENDPATH**/ ?>