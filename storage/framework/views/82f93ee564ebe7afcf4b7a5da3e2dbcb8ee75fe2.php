            ...
            <div class="col-12 col-xs-12">
                <article id="google-panel" class="module">
                    ...
                    <div class="library-inputs">
                        <div class="row">
                            <div class="col-12 col-xs-12">
                            <?php echo e(Form::open(['method' => 'post', 'id' => 'translator'])); ?>

                                <div class="library-inputs">
                                    <div class="row">
                                        <div class="col-xs-6" style="width: 47.5%; margin-left:10px; margin-right: 0.5%">
                                          <?php echo Form::select('translateFrom',['en'=>'English', 'ar'=>'Arabic'], 'en', 
                                                [ 'id' => 'translateFrom',
                                        ...
                                        <div class="col-xs-6" style="width: 47.5%; margin-left: 0.5%;">
                                          <?php echo Form::select('translateTo',['ar'=>'Arabic', 'en'=>'English'], 'ar', 
                                              [ 'id' => 'translateTo',
...
<?php /**PATH /Volumes/Data/sfdbd_new/resources/views/translation/index.blade.php ENDPATH**/ ?>