...
<form method="post" action="<?php echo e(route('external_report.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="modal-body">
        ...
        <!-- name Form Input -->
            <div class="form-group <?php if($errors->has('title')): ?> has-error <?php endif; ?>">
                ...
                <?php echo Form::text('title', null, ['class' => 'form-control', 'placeholder' => 'Name/Title for report', 'required']); ?>
            ...
            <div class="form-group <?php if($errors->has('type')): ?> has-error <?php endif; ?>">
                ...
                <?php echo e(Form::select('type', ['external' => 'External', 'scenario' => 'Scenario'], '' , ['class' => 'form-control'])); ?>
...
<?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/external_report/create.blade.php ENDPATH**/ ?>