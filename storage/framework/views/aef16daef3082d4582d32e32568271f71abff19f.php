    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table = $('#auth_log_table').DataTable({
                'ajax': '<?php echo route("auth_log_datatable"); ?>',
                ordering: true,
                serverSide: true,
                processing: true,
                columns:[
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Data/sfdbd_new/Modules/Admin/Resources/views/auth_logs/index.blade.php ENDPATH**/ ?>