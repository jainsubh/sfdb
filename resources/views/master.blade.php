                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-md-6 col-xs-12">
                                        <article id="analyst-rep-panel" class="module">
                                                ...
                                                <div class="row">
                                                    <div class="col-4 col-xs-4">
                                                        <div class="an-no-item">
                                                            <div class="an-no">{{ $analyst_report_count }}</div>
                                                            <div class="an-txt">total</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-4 col-xs-4">
                                                        <div class="an-no-item">
                                                            <div class="an-no">{{$analyst_report_year}}</div>
                                                            <div class="an-txt">YTD</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-4 col-xs-4">
                                                        <div class="an-no-item">
                                                            <div class="an-no">{{$analyst_report_month}}</div>
                                            ...
                                            <div class="an-rep-content">
                                                    ...
                                                    @if($analyst_report)
                                                    @foreach($analyst_report as $report)
                                                    <div class="an-rep-item">
                                                        <p> 
                                                            @if($report->subject->title != '' && $report->subject_type == 'alert') 
                                                                {{ $report->subject->title }} 
                                                            @elseif($report->subject->title != '' && $report->subject_type == 'freeform_report') 
                                                                {{ $report->subject->title }} 
                                                            @elseif($report->subject->name != '' &&  $report->subject_type == 'institution_report')
                                                                {{ $report->subject->name }} 
                                                            @else
                                                                No Title 
                                                            @endif
                                                        </p>
                                                        <p class="date red"> {{\Carbon\Carbon::parse($report->completed_at, 'UTC')->timezone(auth()->user()->timezone)->isoFormat('lll')}}</p>
                                                    </div>
                                                    @endforeach
                                                    @endif
                                                </div>
                                    ...
                                    <div class="col-12 col-lg-6 col-md-6 col-xs-12">
                                        <article id="inst-rep-panel" class="module">
                                            ...
                                            @if($institution_report_count)
                                            <div class="analyst-numbers">
                                                <div class="row">
                                                    <div class="col-4 col-xs-4">
                                                        <div class="an-no-item">
                                                            <div class="an-no">{{$institution_report_count['institution_report_total']}}</div>
                                                            <div class="an-txt">total</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-4 col-xs-4">
                                                        <div class="an-no-item">
                                                            <div class="an-no">{{$institution_report_count['institution_report_year']}}</div>
                                                            <div class="an-txt">YTD</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-4 col-xs-4">
                                                        <div class="an-no-item">
                                                            <div class="an-no">{{$institution_report_count['institution_report_month']}}</div>
                                                            <div class="an-txt">MTD</div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="an-rep-content-lg">
                                        ...
                                        <div class="marquee-vert" style="height:210px" data-speed=40 data-pauseOnHover='true' data-pauseOnCycle='true' >
                                            @if($monitoring_details)
                                                @foreach($monitoring_details as $key => $value)
                                                <div class="monitoring-item">
                                                    <p class="date red">{{\Carbon\Carbon::parse($value['date_time'], 'UTC')->timezone(auth()->user()->timezone)->isoFormat('lll')}}</p>
                            ...
                            <div class="col-2 col-xl-4 col-lg-4 col-md-6 col-xs-12">
                                <article id="sector-panel" class="module">
                                    ...
                                    <div class="sector-items">
                                        <p>URLs = {{$count['site']}} </p>
                                        <p>Organizations = {{$count['organisation']}}</p>
                                        <p>Search Keywords = {{$count['keywords']}}</p>
                                    </div>
                                    <h3>SECTORS</h3>
                                    <div class="row">
                                        @if($sectors->count())
                                        ...
                                        <div class="col-12 col-xs-12">
                                            <div class="entities-items">
                                                @if($alert_country)
                                                    ...
                                                    @foreach(@$alert_country as $country)
