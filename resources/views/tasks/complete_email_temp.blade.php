                        ...
                        <table class="inner-body" aria-describedby="inner-body">
                           ...
                           <tr>
                              <td class="content-cell" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100vw; padding: 32px;">
                                 ...
                                 <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                   <strong> Task Title : </strong>  {{ ($data->subject_type === 'alert' || $data->subject_type === 'freeform_report'  || $data->subject_type === 'external_report')? $data->subject->title:$data->subject->name }} <br>
                                   <strong> Completed by : </strong> {{ $auth_name }} <br>
                                   <strong> Completed Time : </strong> {{\Carbon\Carbon::parse( $data->completed_at , 'UTC')->setTimezone($timezone)->isoFormat('lll') }} <br>
                                   <strong> Download : </strong> 
                                        @if($data->semi_automatic && $data->semi_automatic->status == 'complete')
                                        <a href="{{ route('semi_automatic.download', $data->semi_automatic->ref_id) }}" style="text-decoration: none; color:black;">
                                            Semi Automatic &nbsp;<i class="fas fa-download" aria-hidden="true"></i>  &nbsp;
                                        </a> 
                                        @endif
                                        @if($data->fully_manual && $data->fully_manual->status == 'complete')
                                        | &nbsp; <a href="{{ route('fully_manual.download', $data->fully_manual->ref_id) }}" style="text-decoration: none; color:black;">
                                    ...
                                    <tr>
                                       <td style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                          <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 14px;">
                                             ...
                                             <a href="{{ route('tasks.index') }}" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">
                                                   {{ route('tasks.index') }}
                                             </a>
                                             </span>
                                          </p>
