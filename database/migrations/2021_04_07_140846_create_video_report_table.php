...
class CreateVideoReportTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('video_report', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('video_report')->unique();
    ...
    {
        Schema::dropIfExists('video_report');
    }
}
